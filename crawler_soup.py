    ...
    if 1:
        ...
        for con1 in youtube_contents:
            ...
            for con2 in youtube_contents:
                ...
                youtube_contents = con2.find('div', class_='style-scope ytd-item-section-renderer sparkles-light-cta')
                # youtube_contents = con2.find('ytd-promoted-sparkles-web-renderer', class_='style-scope ytd-item-section-renderer sparkles-light-cta')
